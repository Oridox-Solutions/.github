...
We explore opportunities across different industries and areas of technology, looking for problems where well-designed software can provide genuine value.
...
We're interested in more than simply creating individual applications. Our aim is to build a portfolio of software products that can grow and evolve over time.

That means continually researching opportunities, experimenting with new ideas and learning from the products we build.

Some ideas will become products.
...
We're currently exploring different markets, technologies and product opportunities rather than limiting ourselves to a single area.

We believe in researching problems carefully, understanding the people affected by them and validating ideas before committing significant resources to development.

As Oridox grows, our aim is to build a diverse portfolio of products while maintaining the same focus on quality, usability and value.
